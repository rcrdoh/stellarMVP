...
export const errorCodes = {
	...
	SERVICE_UNAVAILABLE: defineErrorCode({
		code: "SVC-CORE-5004",
		title: "service_unavailable",
		status: 503,
		category: "DEPENDENCY",
		detail_key: "core.service_unavailable",
		behavior: behavior(
			"safe_if_idempotent",
			"none",
			"none",
	...
	PAYMENT_QUOTE_NOT_FOUND: defineErrorCode({
		code: "SVC-PAYMENT-3001",
		title: "payment_quote_not_found",
		status: 404,
		category: "DECISION_DENY",
		detail_key: "payments.quote_not_found",
		behavior: behavior("never", "none", "none", "NONE"),
		emittable: true,
	}),
	PAYMENT_QUOTE_EXPIRED: defineErrorCode({
		code: "SVC-PAYMENT-3002",
		title: "payment_quote_expired",
		status: 409,
		category: "DECISION_DENY",
		detail_key: "payments.quote_expired",
		behavior: behavior("never", "none", "none", "FIX_AND_RETRY"),
		emittable: true,
	}),
	PAYMENT_PRINCIPAL_NOT_AUTHORIZED: defineErrorCode({
		code: "SVC-PAYMENT-3003",
		title: "payment_principal_not_authorized",
		status: 403,
		category: "DECISION_DENY",
		detail_key: "payments.principal_not_authorized",
		behavior: behavior("never", "none", "contact_support", "NONE"),
		emittable: true,
	}),
	PAYMENT_TRANSACTION_MISMATCH: defineErrorCode({
		code: "SVC-PAYMENT-3004",
		title: "payment_transaction_mismatch",
		status: 409,
		category: "DECISION_DENY",
		detail_key: "payments.transaction_mismatch",
		behavior: behavior("never", "none", "none", "NONE"),
		emittable: true,
	}),
	PAYMENT_INTENT_NOT_FOUND: defineErrorCode({
		code: "SVC-PAYMENT-3005",
		title: "payment_intent_not_found",
		status: 404,
		category: "DECISION_DENY",
		detail_key: "payments.intent_not_found",
		behavior: behavior("never", "none", "none", "NONE"),
		emittable: true,
	}),
