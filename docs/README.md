...
- `guia-puesta-en-marcha-agentic-commerce.md`: pasos operativos para configurar
  localmente y desplegar en Render el agente, Qdrant, embeddings y Stellar
  Testnet, con apartados opcionales de UCP y Vercel.
